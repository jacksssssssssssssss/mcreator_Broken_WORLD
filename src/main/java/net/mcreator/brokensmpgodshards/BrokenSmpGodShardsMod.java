package net.mcreator.brokensmpgodshards;
...
import net.mcreator.brokensmpgodshards.init.BrokenSmpGodShardsModTabs;
...
import net.mcreator.brokensmpgodshards.init.BrokenSmpGodShardsModEnchantments;
import net.mcreator.brokensmpgodshards.init.BrokenSmpGodShardsModBlocks;
import net.mcreator.brokensmpgodshards.init.BrokenSmpGodShardsModBlockEntities;
...
@Mod("broken_smp_god_shards")
public class BrokenSmpGodShardsMod {
	public static final Logger LOGGER = LogManager.getLogger(BrokenSmpGodShardsMod.class);
	public static final String MODID = "broken_smp_god_shards";

	public BrokenSmpGodShardsMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		BrokenSmpGodShardsModSounds.REGISTRY.register(bus);
		BrokenSmpGodShardsModBlocks.REGISTRY.register(bus);
		BrokenSmpGodShardsModBlockEntities.REGISTRY.register(bus);
		BrokenSmpGodShardsModItems.REGISTRY.register(bus);
		BrokenSmpGodShardsModEntities.REGISTRY.register(bus);
		BrokenSmpGodShardsModEnchantments.REGISTRY.register(bus);
		BrokenSmpGodShardsModTabs.REGISTRY.register(bus);
