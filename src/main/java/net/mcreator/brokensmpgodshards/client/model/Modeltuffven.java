...
public class Modeltuffven<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("broken_smp_god_shards", "modeltuffven"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(20, 23).addBox(9.0F, -2.5F, -3.0F, 4.0F, 23.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(95, 75).addBox(10.0F, 17.0F, -6.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.8401F, 0.1275F, 0.1691F));
		PartDefinition cube_r1 = left_arm.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(30, 65).addBox(-4.0F, -4.0F, -5.0F, 12.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
