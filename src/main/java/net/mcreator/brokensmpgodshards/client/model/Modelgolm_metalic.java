...
public class Modelgolm_metalic<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("broken_smp_god_shards", "modelgolm_metalic"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(38, 18).addBox(-1.0F, -13.0F, -3.0F, 5.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 30).addBox(-1.0F, -2.0F, -7.0F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(38, 10).addBox(-7.0F, -7.0F, -5.0F, 8.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(58, 28).addBox(-7.0F, -5.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(56, 18)
						.addBox(2.0F, -7.0F, -5.0F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(56, 40).addBox(1.0F, -7.0F, -5.0F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(58, 58)
						.addBox(-1.0F, -5.0F, -4.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 59).addBox(-5.0F, -5.0F, -4.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(58, 50)
						.addBox(-3.0F, -5.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 30).addBox(-7.0F, -3.0F, -5.0F, 10.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 1.0F, 0.0F));
		PartDefinition rigtarm = partdefinition.addOrReplaceChild("rigtarm", CubeListBuilder.create(), PartPose.offset(-12.0F, 13.0F, 0.0F));
		PartDefinition cube_r2 = rigtarm.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 10).addBox(-1.0F, 2.0F, -5.0F, 13.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -11.0F, -4.0F, -3.1416F, 0.0F, 1.5708F));
		PartDefinition leftarm = partdefinition.addOrReplaceChild("leftarm", CubeListBuilder.create(), PartPose.offset(4.0F, 13.0F, 0.0F));
		...
		PartDefinition leftleg = partdefinition.addOrReplaceChild("leftleg",
				CubeListBuilder.create().texOffs(38, 0).addBox(-1.0F, -2.0F, -7.0F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 40).addBox(-1.0F, -13.0F, -3.0F, 5.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -9.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
