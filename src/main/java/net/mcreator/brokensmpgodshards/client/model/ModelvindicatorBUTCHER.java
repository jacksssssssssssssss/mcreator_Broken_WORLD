...
public class ModelvindicatorBUTCHER<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("broken_smp_god_shards", "modelvindicator_butcher"), "main");
	...
	public ModelvindicatorBUTCHER(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition KNIFE_r1 = left_arm.addOrReplaceChild("KNIFE_r1", CubeListBuilder.create().texOffs(52, 11).addBox(-1.0F, -32.0F, -3.0F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 40.0F, -3.0F, 0.0F, 3.0543F, 0.0F));
		PartDefinition KNIFE_r2 = left_arm.addOrReplaceChild("KNIFE_r2", CubeListBuilder.create().texOffs(36, 1).addBox(-1.0F, -32.0F, -5.0F, 1.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 40.0F, -9.0F, 0.0F, 2.9671F, 0.0F));
