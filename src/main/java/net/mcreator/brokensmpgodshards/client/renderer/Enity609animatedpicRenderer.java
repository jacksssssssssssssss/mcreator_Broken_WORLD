...
public class Enity609animatedpicRenderer extends GeoEntityRenderer<Enity609animatedpicEntity> {
	...
	@Override
	public RenderType getRenderType(Enity609animatedpicEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, Enity609animatedpicEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
