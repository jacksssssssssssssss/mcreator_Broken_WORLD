...
public class MimicanimatedEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	public MimicanimatedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BrokenSmpGodShardsModEntities.MIMICANIMATED.get(), world);
	}

	public MimicanimatedEntity(EntityType<MimicanimatedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mimic");
	}
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((MimicanimatedEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((MimicanimatedEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.iron_trapdoor.close")), 0.15f, 1);
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.iron_trapdoor.close"));
	}

	@Override
	public boolean hurt(DamageSource source, float amount) {
		MimicanimatedEntityIsHurtProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		MimicanimatedEntityProjectile entityarrow = new MimicanimatedEntityProjectile(BrokenSmpGodShardsModEntities.MIMICANIMATED_PROJECTILE.get(), this, this.level());
