...
public class Modelentiysix<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "entiysix"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition nose = partdefinition.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(16, 42).addBox(
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(32, 32).mirror()
						...
						.texOffs(38, 24).addBox(1.0F, 8.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(48, 32).addBox(1.0F, 13.0F, -12.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
						.texOffs(16, 48).addBox(1.0F, 8.0F, -12.0F, 2.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition cube_r1 = left_arm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(24, 42).addBox(-1.0F, 4.0F, -1.0F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 9.0F, -10.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create()
				.texOffs(32, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));
