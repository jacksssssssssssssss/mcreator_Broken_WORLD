...
public class Modelsixoninepic<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sixoninepic"), "main");
	...
	public Modelsixoninepic(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(44, 22).mirror()
						...
						.texOffs(36, 50).addBox(-1.0F, 8.0F, -9.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(0, 22).mirror()
						...
						.texOffs(-1, 1).addBox(-2.0F, 10.0F, -3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(1, 1).addBox(0.0F, 10.0F, -3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));
