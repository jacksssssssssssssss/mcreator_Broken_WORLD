...
public class Modelplayerhatchet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "playerhatchet"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = left_arm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(24, 1).addBox(-1.0F, -2.0F, -2.0F, 5.0F, 1.0F, 2.0F,
		...
		PartDefinition cube_r2 = left_arm.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 1).addBox(-1.0F, -2.0F, -1.0F, 5.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = left_arm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(27, 2)
						.addBox(4.0F, -2.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 2)
						.addBox(4.0F, -2.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 0)
						.addBox(-1.0F, -1.0F, -1.0F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(25, 1)
						.addBox(-1.0F, 2.0F, -1.0F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 11.0F, -7.0F, 1.3586F, 0.0314F, 1.4915F));

		PartDefinition cube_r4 = left_arm.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(23, 33).addBox(-1.0F, -2.0F, -6.0F, 2.0F, 2.0F, 7.0F,
						new CubeDeformation(0.0F)),
