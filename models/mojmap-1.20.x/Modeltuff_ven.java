...
public class Modeltuff_ven<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tuff_ven"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(20, 23)
						.addBox(9.0F, -2.5F, -3.0F, 4.0F, 23.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(60, 39)
						.addBox(9.0F, 21.0F, -15.0F, 2.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(28, 60)
						.addBox(9.0F, 17.0F, -17.0F, 2.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(51, 61)
						.addBox(9.0F, 17.0F, -6.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = left_arm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(29, 58).addBox(-1.0F, 2.0F, -10.0F, 2.0F, 1.0F, 3.0F,
